...
class _ControlSliderMecanicState extends State<ControlSliderMecanic> {
 ...
 //final CarouselController _controller = CarouselController();
   ...
   List<Producto> listaProductos = [
      ...
      Producto(brand: "adidas",name: 'Adidas ForceBounce 2021',model: "air-215", price: "120.00",urlImage: "assets/images/2.png", isFavorite: true),
      ...
      Producto(brand: "adidas",name: 'Adidas ForceBounce 2021',model: "air-187", price: "185.00",urlImage: "assets/images/4.png", isFavorite: true),
      ...
      Producto(brand: "adidas",name: 'Adidas ForceBounce 2021',model: "air-215", price: "120.00",urlImage: "assets/images/6.png", isFavorite: true),
      ...
      Producto(brand: "adidas",name: 'Adidas Essence 2021'    ,model: "air-187", price: "54.00",urlImage: "assets/images/8.png", isFavorite: true),
      ...
      Producto(brand: "adidas",name: 'Adidas Crazyflight 2022',model: "air-187", price: "126.00",urlImage: "assets/images/10.png", isFavorite: true),
      ...
      Producto(brand: "adidas",name: 'Adidas Crazyflight 2021',model: "air-187", price: "126.00",urlImage: "assets/images/12.png", isFavorite: true),
    ];
  ...
  // }
    ...
    Color setColorCard(){
      ...
      if (idx == false) {       
        idx = true; 
        return Color(0xFFeba08e);
      }
      else {
        idx = false;
        return Color(0xFF537DD7);
      } 
    }
  ...
  Widget build(BuildContext context) {
    ...
    .map((item) => Container(
          child: CardProduct(product: item, cardColor:  setColorCard()  ),
        ))
    .toList();
